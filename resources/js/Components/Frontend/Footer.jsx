...
export default function Footer() {
    return (
        <footer className="mt-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300 shadow-inner">
            <div className="max-w-7xl mx-auto px-6 pt-12 pb-5 grid md:grid-cols-4 gap-10">
                {/* Brand Section */}
                <div>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-gray-400">
                        <li className="flex items-center gap-2">
                            ...
                            <span>Jl. Poros Unhas No. 123, Makassar</span>
                        </li>
                        <li className="flex items-center gap-2">
                        ...
                        <li className="flex items-center gap-2">
                            ...
                            <span>himastatfmipaunhas@mail.cpm</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        <a
                            href="#"
                            className="bg-gray-700 hover:bg-indigo-600 transition p-2 rounded-full"
                        >
                            <Facebook size={18} />
                        </a>
                        <a
            ...
            {/* Copyright */}
            <div className="border-t border-gray-700/60 mt-8 py-4 text-center text-sm text-gray-500">
