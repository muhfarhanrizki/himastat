...
export default function Navbar() {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu */}
            {menuOpen && (
                <div className="md:hidden absolute top-full left-0 w-full bg-white/95 backdrop-blur-lg shadow-lg rounded-b-2xl border-t border-gray-200 animate-fadeIn">
                    <ul className="flex flex-col space-y-3 p-4 text-gray-700 font-medium">
                        ...
                        <li>
                            ...
                            {openDropdown && (
                                <ul className="mt-2 ml-3 border-l border-gray-300 pl-3 space-y-2 text-sm text-gray-600">
                                    <li>
                                        <Link
                                            href="/profil-organisasi"
                                            className="block transition-all duration-300 hover:text-gray-700 hover:translate-x-1"
                                            onClick={() => {
                                                setOpenDropdown(false);
                                                setMenuOpen(false);
                                            }}
