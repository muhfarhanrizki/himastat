    ...
    return (
        ...
        >
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
                ...
                <div className="flex gap-8 overflow-x-auto pb-6 pt-2 px-2 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 snap-x snap-mandatory overflow-visible">
                {visibleAlumni.map((item) => (
                    <div
                        key={item.id}
                        className="group flex-shrink-0 w-72 bg-white/80 backdrop-blur-md rounded-3xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-500 p-8 flex flex-col items-center text-center snap-center border border-gray-100"
                    >
                        <div className="mb-5 relative">
                            {item.image ? (
                                ...
                                <div className="w-24 h-24 rounded-full bg-gray-800 flex items-center justify-center text-gray-200 border-4 border-gray-200 shadow-md mx-auto">
                ...
                <div className="mt-8">
                    <Link
                        href="/jejak-alumni"
                        className="inline-flex items-center gap-2 bg-gray-800 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-900 hover:shadow-xl transition-all duration-300 hover:scale-105"
                    >
                        Lihat Semua
                        <ArrowRight size={18} />
                    </Link>
