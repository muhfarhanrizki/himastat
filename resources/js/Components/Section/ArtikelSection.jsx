...
export default function ArtikelSection({ artikel = [] }) {
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-gray-600 mt-5 max-w-2xl mx-auto">
                        Temukan berbagai artikel dan tulisan terbaru mengenai
                        kegiatan, ilmu pengetahuan, serta informasi dari kami.
                    </p>
                </motion.div>
                ...
                <div className="hidden lg:grid lg:grid-cols-3 gap-10">
                    {artikel.map((item, index) => (
                        ...
                        >
                            <Link href={route("artikel.show", item.id)}>
