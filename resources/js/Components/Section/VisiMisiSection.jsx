...
export default function VisiMisiSection({ data }) {
    ...
    return (
        <section id="profil" className="py-24 bg-gradient-to-b from-gray-50 via-gray-100 to-gray-50 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -10 }}
                    >
                        <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-10 shadow-xl border border-gray-200 relative overflow-hidden h-full">
                            ...
                            >
                                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl shadow-lg">
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -10 }}
                    >
                        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-10 shadow-xl relative overflow-hidden h-full">
                            {/* Background Glow Effect */}
                            ...
                            <motion.div
                                className="mb-6 relative z-10"
                            >
                                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-gray-600 to-gray-400 rounded-2xl shadow-lg">
