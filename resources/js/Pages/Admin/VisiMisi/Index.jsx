...
export default function Index({ visimisi = [] }) {
    const handleDelete = (id) => {
        if (
            confirm("Apakah Anda yakin ingin menghapus data Visi & Misi ini?")
        ) {
            router.delete(route("admin.visimisi.destroy", id));
        }
    };
                ...
                <div className="flex items-center justify-between mb-10">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
                            <Target className="text-gray-800" size={28} />
                            Profil Organisasi
                        </h1>
                    ...
                    <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
                        <div className="px-20">
                            <div className="border-b border-b-gray-300 mb-8">
                                ...
                                <p className="font-normal text-md text-gray-500 pb-12 pt-4">
                                    Lorem ipsum dolor sit, amet consectetur
                                    adipisicing elit. Corporis, incidunt? Ipsum
                                    quidem ratione doloremque voluptatem maiores
                                    consequuntur ea tempora quo.
                                </p>
                            </div>
                        </div>
                        <Target
                        ...
                        <p className="text-gray-500 mb-6">
                            Tambahkan visi dan misi untuk memperjelas arah
                            pembangunan desa.
                        </p>
                        <Link
