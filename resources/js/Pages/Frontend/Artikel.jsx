...
import { Search, Calendar, User, BookOpen, X, ChevronLeft, ChevronRight, ArrowRight } from "lucide-react";
import { route } from "ziggy-js";
import FrontendLayout from "@/Layouts/FrontendLayout";

function ArtikelContent({ artikel }) {
    const [searchQuery, setSearchQuery] = useState("");
    const [currentPage, setCurrentPage] = useState(1);
    const itemsPerPage = 6;

    const filteredArtikel = useMemo(() => {
        if (!searchQuery.trim()) return artikel;
    ...
    const currentItems = filteredArtikel.slice(startIndex, endIndex);
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-gray-300 max-w-2xl mx-auto text-base md:text-lg px-4">
                            Wawasan dan pengetahuan seputar kegiatan dan edukasi kami
                        </p>
                    </motion.div>
                </div>
            </section>
