...
function ArtikelDetailContent({ artikel, recommendedArticles }) {
...
export default function ArtikelDetail({ artikel, recommendedArticles }) {
    return (
        <FrontendLayout>
            <Head title={artikel.judul} />
            <ArtikelDetailContent artikel={artikel} recommendedArticles={recommendedArticles} />
        </FrontendLayout>
    );
}